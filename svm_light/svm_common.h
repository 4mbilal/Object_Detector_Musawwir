...
typedef struct svector {
  mWORD    *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(mWORD *, char *, double);
...
int    parse_document(char *, mWORD *, double *, long *, long *, double *, long *, long, char **);
